...
/*
	Refs:
	- https://github.com/corpix/loggers/blob/master/logger/nsq/nsq.go
*/
...
func init() {
	logrus_mate.RegisterHook("Config", NewNsqHook)
}

func NewNsqHook(config logrus_mate.Configuration) (hook logrus.Hook, err error) {
	conf := Config{}
