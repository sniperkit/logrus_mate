...
import (
	"github.com/csu/logrus_socketio"
...
func init() {
	logrus_mate.RegisterHook("Config", NewSocketioHook)
}

func NewSocketioHook(config logrus_mate.Configuration) (hook logrus.Hook, err error) {
	conf := Config{}
	...
	hook, err = logrus_socketio.NewHook()
