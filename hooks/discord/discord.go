...
func init() {
	logrus_mate.RegisterHook("Config", NewDiscordHook)
}

func NewDiscordHook(config logrus_mate.Configuration) (hook logrus.Hook, err error) {
	conf := Config{}
